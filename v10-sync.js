/* F&B Manager V10 — single browser entry point
   Load shared core modules first, then the online data/auth engine,
   then the isolated UI integration layer. index.html keeps loading only this file.
*/
(function(){
  'use strict';
